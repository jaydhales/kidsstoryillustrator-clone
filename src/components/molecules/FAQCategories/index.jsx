  ...
  return (
    <div className="FAQCategories">
      ...
      <div className="sub-helpCategories-container">
        <div
          className="gettingStarted-container categoriess_con"
          onClick={handleStartingQuestion}
        >
          <img className="categories-img" src={started} alt="/" />
          <h3>Getting started</h3>
        </div>
        <div className="pricing-container categoriess_con" onClick={handlePricingQuestion}>
          <img className="categories-img" src={pricing} alt="/" />
          <h3>Pricing</h3>
        </div>
        <div className="features-container categoriess_con" onClick={handleFeaturesQuestion}>

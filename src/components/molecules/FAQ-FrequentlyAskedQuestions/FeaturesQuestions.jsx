...
export const FeaturesQuestions = () => {
  ...
  const handleQuestionThree = () => {
    ...
    {!featureOne ? <p>Yes, simply activate the push notification
      button to sift information and updates on the app</p> : ''}
        </div>
    ...
    <div className='sub-question'>
      ...
      {!featureTwo ? <p>Yes, your email are 100% safe with us, dont worry your details won&#39;t
      ...
      {!featureThree ? <p>You can only get to save your stories after 
        paying for a preferred pricing package</p> : ''}
      </div>
    </div>
}

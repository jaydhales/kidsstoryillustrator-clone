...
export const Pricing = () => {
  return (<div className="Pricing">
    <div className="heading">
      ...
      <p className="sub-title">Try for free for 14 days, no commitment, no credit card required</p>
    </div>
    <div className="plan">
      <p>Monthly billing</p>
      <div className="card">
        <div className="cardone">
          ...
          <a href="#"><button className="btn-light">Sign Up</button></a>
        </div>
        <div className="cardtwo">
          <div className="card-head2">
            <p className="title">Growth</p>
            <p className="amount"> <sup className="figure">us$ </sup>2<sup className="figure"> .00</sup></p>
          </div>
          ...
          <a href="#"><button className="btn-lighttwo">Sign Up</button></a>
        </div>
      </div>
    </div>
  </div>
